...
public class MainController {
    ...
    public void initialize() {
        ...
        cloudLabel.setText(""+ weather.getCurrent().getCloud());
    ...
    public void hourlyCurrentDay(){
        date1.setText("" + weather.getForecast().getForecastday().get(0).getDate());
